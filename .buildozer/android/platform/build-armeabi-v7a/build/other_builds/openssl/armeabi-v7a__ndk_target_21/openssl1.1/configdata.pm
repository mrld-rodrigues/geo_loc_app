...
our %config = (
  ...
  CPPFLAGS => [ "-DANDROID -I/home/mrldrodor/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include -I/home/mrldrodor/Documentos/mrld_projetos/app_geo_loc/.buildozer/android/platform/build-armeabi-v7a/build/python-installs/geolocapp/armeabi-v7a/include/python3.1" ],
  CPPINCLUDES => [  ],
  CXX => "/usr/bin/ccache /home/mrldrodor/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/clang++ -target armv7a-linux-androideabi21 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC",
  ...
  perlenv => {
      ...
      "PERL" => undef,
      "RANLIB" => "/home/mrldrodor/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ranlib",
      "RC" => undef,
      "RCFLAGS" => undef,
      "WINDRES" => undef,
      "__CNF_CFLAGS" => undef,
